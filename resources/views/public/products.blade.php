...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Josefin+Sans:wght@400;500;700&family=Montserrat:wght@600;800;900&family=Poppins:wght@400;600&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="/figma/styles/website_parts/products.css">
    <title>Products & Deals | VisitKL</title>
</head>
<body>
    <header class="header">
        <nav class="nav">
    ...
    <main>
        <section class="intro">
            <div class="intro__head">
                <img class="intro__head--title" src="/figma/src/logos/products_title.png" alt="products and services title"/>
            </div>
            <p class="intro__text">
        ...
        <section class="content">
            <h2 class="content__title">Make the right choice and discover the best product & services for you!</h2>
